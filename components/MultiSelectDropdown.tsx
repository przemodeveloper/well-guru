  ...
  return (
    <div className="w-full max-w-md">
      <div className="relative" ref={dropdownRef}>
        {/* Dropdown trigger */}
        <div
          className="min-h-[42px] w-full text-left px-3 py-2 border border-gray-300 rounded-lg bg-white cursor-pointer hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
